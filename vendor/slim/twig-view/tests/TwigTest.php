...
class TwigTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSingleNamespaceAndMultipleDirectories()
    {
        ...
        $outputMulti = $view->fetch('@namespace/directory/templates/example.html', [
            'weekday' => $weekday,
        ]);
    ...
    public function testMultipleTemplatesWithMultipleNamespace()
    {
        ...
        $outputThree = $views->fetch('@Three/directory/templates/example.html', [
            'weekday' => $weekday,
        ]);
    ...
    public function testMultipleDirectoriesWithoutNamespaces()
    {
        ...
        $rootDirectory = $view->fetch('directory/templates/example.html', [
            'weekday' => $weekday,
        ]);
