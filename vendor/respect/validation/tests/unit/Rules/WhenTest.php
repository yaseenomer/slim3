...
class WhenTest extends RuleTestCase
{
     ...
     * @expectedExceptionMessage Exceptions for ThenNotValid:assert() method
     */
    ...
    /**
     * @expectedException Respect\Validation\Exceptions\ValidationException
     * @expectedExceptionMessage Exceptions for ThenNotValid:check() method
     */
    ...
    /**
     * @expectedException Respect\Validation\Exceptions\ValidationException
     * @expectedExceptionMessage Exceptions for ElseNotValid:assert() method
     */
    ...
    /**
     * @expectedException Respect\Validation\Exceptions\ValidationException
     * @expectedExceptionMessage Exceptions for ElseNotValid:check() method
     */
