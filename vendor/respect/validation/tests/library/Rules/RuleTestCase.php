    ...
    public function getRuleMock($expectedResult, $mockClassName = '')
    {
        ...
        if ($expectedResult) {
            ...
            $ruleMocked
                ->expects($this->any())
                ->method('check')
                ->willThrowException(new ValidationException('Exceptions for '.$mockClassName.':check() method'))
            ;
            $ruleMocked
                ->expects($this->any())
                ->method('assert')
                ->willThrowException(new ValidationException('Exceptions for '.$mockClassName.':assert() method'))
            ;
        }
